...
<div className="my-12 p-8 bg-green-50 rounded-3xl border border-green-100 not-prose">
  <h4 className="text-xl font-semibold text-green-900 mb-4">Benefits of Upfront Payments:</h4>
  <div className="grid md:grid-cols-2 gap-6">
    <div className="p-4 bg-white rounded-xl border border-green-200">
      <DollarSign className="size-8 text-green-600 mb-3" />
      <h5 className="font-semibold text-green-800 mb-2">Cash Flow Control</h5>
      <p className="text-sm text-green-700">Money comes in before expenses go out</p>
    </div>
    <div className="p-4 bg-white rounded-xl border border-green-200">
      <Shield className="size-8 text-green-600 mb-3" />
      <h5 className="font-semibold text-green-800 mb-2">Risk Reduction</h5>
...
<div className="my-12 p-8 bg-slate-50 rounded-3xl border border-slate-200 not-prose">
  <h4 className="text-xl font-semibold text-slate-900 mb-6 text-center">Monthly Revenue Scenarios</h4>
  <div className="grid md:grid-cols-3 gap-6">
    <div className="p-6 bg-white border border-slate-200 rounded-xl text-center">
      ...
      <h5 className="font-semibold text-slate-900 mb-2">Upfront</h5>
    ...
    <div className="p-6 bg-white border border-slate-200 rounded-xl text-center">
      ...
      <h5 className="font-semibold text-slate-900 mb-2">Net 15</h5>
    ...
    <div className="p-6 bg-white border border-slate-200 rounded-xl text-center">
      ...
      <h5 className="font-semibold text-slate-900 mb-2">Net 30</h5>
...
<div className="my-12 p-8 bg-amber-50 rounded-3xl border border-amber-100 not-prose">
  <h4 className="text-xl font-semibold text-amber-900 mb-4">Prevention Strategies:</h4>
...
<div className="my-16 p-12 bg-slate-900 rounded-[3rem] text-white text-center relative overflow-hidden not-prose">
  ...
  <div className="relative z-10">
    ...
    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
      <Link href="/pricing" className="w-full sm:w-auto px-10 py-5 bg-green-600 hover:bg-green-700 text-white rounded-2xl font-semibold transition-all text-lg shadow-2xl shadow-green-600/40">
        Start Managing Payments
      </Link>
      <Link href="/templates" className="w-full sm:w-auto px-10 py-5 bg-white/10 hover:bg-white/20 text-white rounded-2xl font-semibold transition-all text-lg border border-white/20">
