...
<div className="text-center py-16 md:py-20 px-4 not-prose">
  <div className="container mx-auto max-w-6xl">
    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-green-50 text-green-600 text-sm font-semibold mb-6">
      PRICING ANALYSIS
    </div>
...
<div className="grid md:grid-cols-2 gap-8 my-12 not-prose">
  <div className="p-8 bg-white border border-slate-200 rounded-3xl shadow-sm">
    ...
    <h4 className="text-slate-500 font-semibold mb-6 text-sm uppercase tracking-widest">Enterprise Giants</h4>
  ...
  <div className="p-8 bg-blue-600 text-white rounded-3xl shadow-xl shadow-blue-600/20">
    ...
    <h4 className="text-blue-200 font-semibold mb-6 text-sm uppercase tracking-widest">Boopsign (Solo Pro)</h4>
...
<div className="my-16 p-10 bg-slate-50 rounded-3xl border border-slate-100 italic not-prose">
  ...
  <div className="mt-4 not-italic font-semibold text-slate-900">— Sarah J., Creative Director</div>
</div>
...
<div className="mt-24 p-12 bg-slate-900 rounded-[3rem] text-white text-center relative overflow-hidden not-prose">
  ...
  <div className="relative z-10">
    ...
    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
      <Link href="/sign-in" className="w-full sm:w-auto px-10 py-5 bg-blue-600 hover:bg-blue-700 text-white rounded-2xl font-semibold transition-all text-xl shadow-2xl">
        Try it for $20/mo
      </Link>
    </div>
  </div>
