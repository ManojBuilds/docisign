...
export default function AuthLayout({
  ...
  return (
    <main className="relative flex min-h-svh md:h-svh w-full bg-white text-slate-900 selection:bg-blue-100 selection:text-blue-900">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex items-center gap-4">
                <div className="flex -space-x-3">
                  {[1, 2, 3, 4].map((i) => (
                    <div key={i} className="relative h-10 w-10 rounded-full border-2 border-slate-950 bg-slate-800 flex items-center justify-center text-[10px] font-bold text-slate-500 overflow-hidden">
      ...
      <div className="relative flex flex-1 flex-col items-center justify-center p-4 sm:p-8 lg:p-12 xl:p-24 min-h-[100dvh] overflow-y-auto">
        <div className="w-full max-w-[420px] py-12 flex flex-col justify-center min-h-full">
          ...
          <div className="relative min-h-[480px] flex flex-col items-center justify-center">
            <div className="w-full">
              {children}
            </div>
          </div>

          <div className="mt-8 text-center border-t border-slate-50 pt-10">
            <p className="text-[10px] text-slate-400 flex items-center justify-center gap-2 group cursor-default uppercase tracking-[0.2em] font-bold">
              <ShieldCheck className="h-3.5 w-3.5 text-blue-500/50" strokeWidth={2.5} />
