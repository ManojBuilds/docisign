      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 mb-8">
            This page is currently under construction. We're working hard to bring you the best practices for enabling seamless document signing for distributed teams.
          </p>
        </div>
