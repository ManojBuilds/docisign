...
export const metadata: Metadata = {
  ...
  description:
    "Looking for a HelloSign alternative? BoopSign is 52% cheaper ($15 vs $25/month), 3x faster, and mobile-first. No account needed for signers. Try free for 7 days.",
  keywords: [
  ...
  openGraph: {
    title: "Best HelloSign Alternative 2026 | BoopSign vs Dropbox Sign",
    description:
  ...
  twitter: {
    ...
    title: "Best HelloSign Alternative 2026 | BoopSign",
...
const hellosignFaq = [
  ...
  },
  {
    ...
    answer:
      "BoopSign is significantly cheaper. HelloSign (Dropbox Sign) Standard plan costs $25/user/month, while BoopSign Pro is just $15/month total—that's 52% cheaper. No per-user fees, no hidden costs, unlimited signatures. You save $156/year compared to HelloSign.",
  },
  {
    id: "faq-5",
            ...
            <Card className="bg-white border-2 border-red-200">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-sm text-gray-600">
                  HelloSign Standard went from $15/month (2020) to $25/month (2026).
      ...
      <section id="compare" className="py-16 md:py-20 px-4 bg-gray-50">
        <div className="container mx-auto max-w-5xl text-center">
          ...
          <p className="text-xl mb-12 text-gray-600">
            See how BoopSign stacks up against HelloSign (Dropbox Sign) in 2026
          </p>
            ...
            <Card className="border-2 hover: transition-">
              ...
              <CardContent>
                <p className="text-gray-600">
                  Pay just $15/month instead of HelloSign&apos;s $25/user/month.
