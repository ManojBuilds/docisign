...
export const metadata: Metadata = {
  title: "Free NDA Templates | Download & Customize | Coming Soon",
  description:
    "Access free NDA templates to protect your business. This page is currently under construction.",
  keywords: [
    "free NDA templates",
...
export default function NdaTemplateFreePage() {
  return (
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 mb-8">
            This page is currently under construction. We're working hard to bring you the best free NDA templates for your business needs.
          </p>
        </div>
          ...
          <CardContent>
            <ul className="space-y-4 text-gray-700">
              <li className="flex items-start">
                ...
                <span>Free customizable NDA templates</span>
              </li>
              <li className="flex items-start">
                <div className="flex-shrink-0 w-6 h-6 bg-green-100 rounded-full flex items-center justify-center mr-3 mt-1">
                  <span className="text-green-600 text-sm">✓</span>
              ...
              <li className="flex items-start">
                ...
                <span>Easy download and customization</span>
              </li>
            </ul>
          </CardContent>
        </Card>
          ...
          <Card className="bg-white shadow-lg">
            ...
            <CardContent>
              ...
              <Button asChild className="w-full">
                <Link href="mailto:mkumar.react@gmail.com?subject=Notify me about Free NDA Templates">
