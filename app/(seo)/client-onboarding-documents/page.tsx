...
export const metadata: Metadata = {
  ...
  description:
    "Learn how to streamline your client onboarding process with digital documents. This page is currently under construction.",
  keywords: [
          ...
          <CardContent>
            <ul className="space-y-4 text-gray-700">
              <li className="flex items-start">
                ...
                <span>Digital client intake forms</span>
              </li>
              <li className="flex items-start">
                <div className="flex-shrink-0 w-6 h-6 bg-green-100 rounded-full flex items-center justify-center mr-3 mt-1">
                  <span className="text-green-600 text-sm">✓</span>
                </div>
                <span>Streamlined onboarding workflows</span>
              </li>
              <li className="flex items-start">
                <div className="flex-shrink-0 w-6 h-6 bg-green-100 rounded-full flex items-center justify-center mr-3 mt-1">
                  <span className="text-green-600 text-sm">✓</span>
              ...
              <li className="flex items-start">
                ...
                <span>Secure client data handling</span>
              </li>
              <li className="flex items-start">
                <div className="flex-shrink-0 w-6 h-6 bg-green-100 rounded-full flex items-center justify-center mr-3 mt-1">
                  <span className="text-green-600 text-sm">✓</span>
                </div>
                <span>Faster contract turnaround times</span>
              </li>
            </ul>
          </CardContent>
        </Card>
          ...
          <Card className="bg-white shadow-lg">
            ...
            <CardContent>
              ...
              <Button asChild className="w-full">
                <Link href="mailto:mkumar.react@gmail.com?subject=Notify me about Client Onboarding Documents">
