        ...
        <section className="py-20 md:py-28 bg-white">
          <div className="container mx-auto px-4 max-w-5xl text-center">
            <h1 className="text-4xl md:text-6xl font-black text-slate-900 mb-6">
              E-Signature Tool <span className="text-blue-600">Freelancers</span> Actually Use
            </h1>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto mb-10">
              Get your NDAs, contracts, and proposals signed in under 90 seconds. No client accounts required. Built specifically for freelancers like you.
            </p>
          ...
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-slate-600 max-w-3xl mx-auto">
                Unlike enterprise tools, Boopsign is built specifically for freelancers who need to get contracts signed quickly and reliably.
              </p>
            </div>
          ...
          <div className="container mx-auto px-4 max-w-5xl">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-slate-600">
                Whether you're a designer, developer, writer, or consultant, Boopsign works for your workflow.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description: "Send contracts for design projects, get client approvals, and manage revisions seamlessly."
                },
                {
                  title: "Developers & Programmers",
                  description: "Share service agreements, NDAs, and project specifications with clients and contractors."
                },
                {
                  title: "Writers & Content Creators",
                  description: "Send publishing agreements, content licensing contracts, and editorial contracts."
                },
                {
                  title: "Consultants & Coaches",
                  description: "Distribute service agreements, consulting contracts, and engagement letters."
                }
              ].map((scenario, index) => (
        ...
        <section className="py-20 bg-blue-600 text-white">
          <div className="container mx-auto px-4 text-center max-w-3xl">
            <h2 className="text-3xl md:text-4xl font-black mb-6">
              Get More Freelance Contracts Signed
            </h2>
            <p className="text-xl mb-10 opacity-90">
              Join thousands of freelancers who've switched to a simpler, more effective e-signature solution.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
