...
const Faq = ({
  items = [
    ...
    },
    {
      ...
      answer: "We offer a single, simple plan for $15/month that includes unlimited documents and signers. There are no per-envelope fees or hidden charges. You can also start with a 7-day free trial to see how much time it saves you before committed."
    },
    {
      id: "faq-1",
