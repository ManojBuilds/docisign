...
const Cta = () => {
  return (
    <section className="py-20 flex flex-col items-center text-center">
      {/* Avatars row */}
      <span
        className="mx-4 inline-flex items-center -space-x-4 mb-6"
        aria-label="User testimonials profile pictures"
      >
      ...
      <h2 className="text-4xl md:text-5xl font-bold tracking-tight mb-4">
        Get your contracts signed in{" "}
        <span className="font-extrabold">under 3 minutes</span>
      </h2>
      ...
      {/* Benefits List */}
      <div className="flex flex-col sm:flex-row gap-6 mb-8 px-0.5 text-sm text-gray-500">
