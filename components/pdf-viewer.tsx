...
export default function PDFViewer({
    ...
    const { pageDimensions, scale, setPageDimensions, setScale } = usePdfDimensions()
    ...
    const onPageRenderSuccess = useCallback(
        (page: any) => {
            ...
            setPageDimensions((prev: Record<number, { width: number; height: number }>) => ({
                ...prev,
    ...
    }, [pageDimensions, pageNumber, scale, handleScaleChange, isMobile, setScale]);
    ...
    return (
        <div className={`flex flex-col h-full ${className}`}>
            ...
            {showControls && numPages > 0 && (
                <div className="flex items-center justify-center p-2 md:p-4 bg-background border-b border-border">
