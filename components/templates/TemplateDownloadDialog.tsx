...
import { Loader2, Download, User, Mail, FileText, Lock } from "lucide-react";
...
export function TemplateDownloadDialog({
    ...
    return (
        <ResponsiveDialog open={open} onOpenChange={setOpen}>
            ...
            <ResponsiveDialogContent className="sm:max-w-[440px] p-0 gap-0 overflow-hidden border-none shadow-2xl bg-white">
                <div className="relative">
                    ...
                    <form onSubmit={handleSubmit} className="relative z-10 p-6 sm:p-8">
                        <ResponsiveDialogHeader>
                            ...
                            <ResponsiveDialogTitle className="font-black text-center text-slate-900">
                                Get Your Template
                            </ResponsiveDialogTitle>
                            <ResponsiveDialogDescription className="text-center text-slate-600 pt-2 pb-6">
