...
export const sendTrialDay3Email = action({
    args: {
        email: v.string(),
        name: v.string(),
    },
        ...
        try {
            const res = await resend.sendEmail(ctx, {
                ...
                html: await render(
                    TrialDay3({
                        userName: args.name,
                        createTemplateUrl: `${domain}/dashboard`,
                    }),
                ),
            });
            console.log(`Trial Day 3 email sent to ${args.email}`, res);
        } catch (error) {
...
export const sendTrialDay7Email = action({
    args: {
        email: v.string(),
        name: v.string(),
    },
        ...
        try {
            const res = await resend.sendEmail(ctx, {
                ...
                html: await render(
                    TrialDay7({
                        userName: args.name,
                        upgradeUrl: `${domain}/#pricing`,
                    }),
                ),
            });
            console.log(`Trial Day 7 email sent to ${args.email}`, res);
        } catch (error) {
...
export const sendTrialDay10Email = action({
    args: {
        email: v.string(),
        name: v.string(),
    },
    handler: async (ctx, args) => {
        try {
            ...
            console.log(`Trial Day 10 email sent to ${args.email}`, res);
        } catch (error) {
            console.error("Trial Day 10 email failed:", error);
        }
    },
});

export const sendTrialDay13Email = action({
    args: {
        email: v.string(),
        name: v.string(),
    },
    handler: async (ctx, args) => {
        try {
            ...
            console.log(`Trial Day 13 email sent to ${args.email}`, res);
        } catch (error) {
            console.error("Trial Day 13 email failed:", error);
        }
    },
});
...
export const sendSequenceEmail = action({
    ...
    handler: async (ctx, args) => {
        try {
            const template = getTemplateBySlug(args.source);
