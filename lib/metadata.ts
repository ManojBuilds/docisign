...
export const generatePageMetadata = {
  ...
  blog: (title?: string, description?: string): Metadata => ({
    title: title
      ? `${title} - ${SEO_CONFIG.siteName} Blog`
      : `Blog - Document Signing Tips & Guides | ${SEO_CONFIG.siteName}`,
    description:
      description ||
      "Expert tips, guides, and insights on document signing, e-signatures, and business productivity. Learn how to streamline your document workflows.",
    openGraph: {
      title: title
        ? `${title} - ${SEO_CONFIG.siteName} Blog`
        : `${SEO_CONFIG.siteName} Blog - Document Signing Tips & Guides`,
      description:
        description ||
        "Expert tips and guides on document signing, e-signatures, and business productivity.",
  ...
  signUp: (): Metadata => ({
    ...
    openGraph: {
      ...
      description:
        "Create your free account and start signing documents instantly. No credit card required.",
